 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.dslreasoner.logic.model.logiclanguage.impl.DistinctImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DistinctImpl extends PrimitiveRelationImpl implements Distinct {
	/**
	...
	protected EClass eStaticClass() {
		return LogiclanguagePackage.Literals.DISTINCT;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LogiclanguagePackage.DISTINCT__OPERANDS:
