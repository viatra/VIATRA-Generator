...
public class InternalCftLanguageLexer extends Lexer {
    ...
    public final void mT__29() throws RecognitionException {
        try {
            int _type = T__29;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCftLanguage.g:27:7: ( 'toplevel' )
            // InternalCftLanguage.g:27:9: 'toplevel'
            {
            match("toplevel"); 
    ...
    public final void mT__30() throws RecognitionException {
        try {
            int _type = T__30;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCftLanguage.g:28:7: ( 'mapping' )
            // InternalCftLanguage.g:28:9: 'mapping'
            {
            match("mapping"); 
    ...
    public final void mT__34() throws RecognitionException {
        try {
            int _type = T__34;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCftLanguage.g:32:7: ( 'lookup' )
            // InternalCftLanguage.g:32:9: 'lookup'
            {
            match("lookup"); 
    ...
    public final void mT__35() throws RecognitionException {
        try {
            int _type = T__35;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCftLanguage.g:33:7: ( 'as' )
            // InternalCftLanguage.g:33:9: 'as'
            {
            match("as"); 
    ...
    public final void mT__39() throws RecognitionException {
        try {
            int _type = T__39;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCftLanguage.g:37:7: ( '=>' )
            // InternalCftLanguage.g:37:9: '=>'
            {
            match("=>"); 
