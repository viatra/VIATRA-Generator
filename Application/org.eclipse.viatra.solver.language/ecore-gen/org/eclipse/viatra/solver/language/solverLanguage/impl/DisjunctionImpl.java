 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.viatra.solver.language.solverLanguage.impl.DisjunctionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DisjunctionImpl extends ExpressionImpl implements Disjunction {
	...
	protected EClass eStaticClass() {
		return SolverLanguagePackage.Literals.DISJUNCTION;
	}
	...
	public EList<Expression> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<Expression>(Expression.class, this, SolverLanguagePackage.DISJUNCTION__CHILDREN);
		}
		return children;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SolverLanguagePackage.DISJUNCTION__CHILDREN:
