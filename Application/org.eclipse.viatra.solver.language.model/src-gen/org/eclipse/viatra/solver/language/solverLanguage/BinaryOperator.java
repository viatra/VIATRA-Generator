...
public enum BinaryOperator implements Enumerator {
	 ...
	 * @ordered
	 */
	LESS_EQUALS(9, "LESS_EQUALS", "LESS_EQUALS"),
	 ...
	 * @generated
	 */
	private static final BinaryOperator[] VALUES_ARRAY = new BinaryOperator[] { PLUS, MINUS, MULTIPLY, DIVIDE, POW, IN,
