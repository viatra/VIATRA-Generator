 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.viatra.solver.language.solverLanguage.impl.AggregationImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.viatra.solver.language.solverLanguage.impl.AggregationImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregationImpl extends AggregateExpressionImpl implements Aggregation {
	/**
	...
	public NotificationChain basicSetValue(Expression newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SolverLanguagePackage.AGGREGATION__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SolverLanguagePackage.AGGREGATION__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SolverLanguagePackage.AGGREGATION__VALUE, newValue,
					newValue));
	}
	...
	public Symbol getOp() {
		if (op != null && op.eIsProxy()) {
			...
			op = (Symbol) eResolveProxy(oldOp);
			if (op != oldOp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SolverLanguagePackage.AGGREGATION__OP,
							oldOp, op));
			}
		}
		return op;
	 ...
	 * @generated
	 */
	public void setOp(Symbol newOp) {
		Symbol oldOp = op;
		op = newOp;
		if (eNotificationRequired())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SolverLanguagePackage.AGGREGATION__VALUE:
