 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.viatra.solver.language.solverLanguage.impl.VariableImpl#getTypeReference <em>Type Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends SymbolImpl implements Variable {
	...
	public NotificationChain basicSetTypeReference(TypeReference newTypeReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SolverLanguagePackage.VARIABLE__TYPE_REFERENCE, oldTypeReference, newTypeReference);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTypeReference != typeReference) {
			...
			if (typeReference != null)
				msgs = ((InternalEObject) typeReference).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SolverLanguagePackage.VARIABLE__TYPE_REFERENCE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SolverLanguagePackage.VARIABLE__TYPE_REFERENCE,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SolverLanguagePackage.VARIABLE__TYPE_REFERENCE:
