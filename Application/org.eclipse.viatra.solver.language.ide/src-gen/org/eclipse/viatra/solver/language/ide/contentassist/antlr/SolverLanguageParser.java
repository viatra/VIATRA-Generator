...
public class SolverLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SolverLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAggregationOpAccess().getAlternatives(), "rule__AggregationOp__Alternatives");
			...
			builder.put(grammarAccess.getExternPredicateDefinitionAccess().getHeadAssignment_1(), "rule__ExternPredicateDefinition__HeadAssignment_1");
			...
			builder.put(grammarAccess.getExternMetricDefinitionAccess().getHeadAssignment_2(), "rule__ExternMetricDefinition__HeadAssignment_2");
			...
			builder.put(grammarAccess.getCountAccess().getBodyAssignment_2(), "rule__Count__BodyAssignment_2");
			...
			builder.put(grammarAccess.getNamedElementAccess().getNameAssignment(), "rule__NamedElement__NameAssignment");
		}
	}
