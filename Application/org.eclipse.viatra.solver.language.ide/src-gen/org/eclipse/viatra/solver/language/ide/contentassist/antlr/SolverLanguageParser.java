...
public class SolverLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SolverLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBasicInterpretationAccess().getGroup_1(), "rule__BasicInterpretation__Group_1__0");
			builder.put(grammarAccess.getBasicInterpretationAccess().getGroup_1_1(), "rule__BasicInterpretation__Group_1_1__0");
			builder.put(grammarAccess.getBasicInterpretationAccess().getGroup_1_1_1(), "rule__BasicInterpretation__Group_1_1_1__0");
			...
			builder.put(grammarAccess.getPredicateAccess().getGroup_2_1(), "rule__Predicate__Group_2_1__0");
			builder.put(grammarAccess.getPredicateAccess().getGroup_2_1_1(), "rule__Predicate__Group_2_1_1__0");
			builder.put(grammarAccess.getPredicateAccess().getGroup_4_1(), "rule__Predicate__Group_4_1__0");
			builder.put(grammarAccess.getPredicateAccess().getGroup_4_1_1(), "rule__Predicate__Group_4_1_1__0");
			...
			builder.put(grammarAccess.getConstraintAccess().getGroup_0_2_2(), "rule__Constraint__Group_0_2_2__0");
			builder.put(grammarAccess.getConstraintAccess().getGroup_1(), "rule__Constraint__Group_1__0");
			builder.put(grammarAccess.getConstraintAccess().getGroup_1_3(), "rule__Constraint__Group_1_3__0");
			...
			builder.put(grammarAccess.getBasicInterpretationAccess().getObjectsAssignment_1_1_0(), "rule__BasicInterpretation__ObjectsAssignment_1_1_0");
			builder.put(grammarAccess.getBasicInterpretationAccess().getObjectsAssignment_1_1_1_1(), "rule__BasicInterpretation__ObjectsAssignment_1_1_1_1");
			builder.put(grammarAccess.getBasicInterpretationAccess().getValueAssignment_3(), "rule__BasicInterpretation__ValueAssignment_3");
			...
			builder.put(grammarAccess.getPredicateAccess().getIsErrorAssignment_0(), "rule__Predicate__IsErrorAssignment_0");
			builder.put(grammarAccess.getPredicateAccess().getSymbolAssignment_1(), "rule__Predicate__SymbolAssignment_1");
			builder.put(grammarAccess.getPredicateAccess().getParametersAssignment_2_1_0(), "rule__Predicate__ParametersAssignment_2_1_0");
			builder.put(grammarAccess.getPredicateAccess().getParametersAssignment_2_1_1_1(), "rule__Predicate__ParametersAssignment_2_1_1_1");
			builder.put(grammarAccess.getPredicateAccess().getBodiesAssignment_4_1_0(), "rule__Predicate__BodiesAssignment_4_1_0");
			builder.put(grammarAccess.getPredicateAccess().getBodiesAssignment_4_1_1_1(), "rule__Predicate__BodiesAssignment_4_1_1_1");
			...
			builder.put(grammarAccess.getConstraintAccess().getPolarityAssignment_0_0(), "rule__Constraint__PolarityAssignment_0_0");
			builder.put(grammarAccess.getConstraintAccess().getSymbolAssignment_0_1(), "rule__Constraint__SymbolAssignment_0_1");
			builder.put(grammarAccess.getConstraintAccess().getParamsAssignment_0_2_1(), "rule__Constraint__ParamsAssignment_0_2_1");
			builder.put(grammarAccess.getConstraintAccess().getParamsAssignment_0_2_2_1(), "rule__Constraint__ParamsAssignment_0_2_2_1");
			builder.put(grammarAccess.getConstraintAccess().getClosureTypeAssignment_1_0(), "rule__Constraint__ClosureTypeAssignment_1_0");
			builder.put(grammarAccess.getConstraintAccess().getParamsAssignment_1_2(), "rule__Constraint__ParamsAssignment_1_2");
			builder.put(grammarAccess.getConstraintAccess().getParamsAssignment_1_3_1(), "rule__Constraint__ParamsAssignment_1_3_1");
