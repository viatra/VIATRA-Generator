		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClosure_RuleAccess().getAlternatives(), "rule__Closure_Rule__Alternatives");
					...
					put(grammarAccess.getVLSFunctionAccess().getConstantAlternatives_1_0(), "rule__VLSFunction__ConstantAlternatives_1_0");
					put(grammarAccess.getVLSFofTermAccess().getAlternatives(), "rule__VLSFofTerm__Alternatives");
					put(grammarAccess.getVLSFunctionFofAccess().getNameAlternatives_0_0(), "rule__VLSFunctionFof__NameAlternatives_0_0");
					put(grammarAccess.getVLSDefinedTermAccess().getNameAlternatives_0(), "rule__VLSDefinedTerm__NameAlternatives_0");
					...
					put(grammarAccess.getClosure_RuleAccess().getGroup_1(), "rule__Closure_Rule__Group_1__0");
					...
					put(grammarAccess.getVLSFunctionAccess().getGroup(), "rule__VLSFunction__Group__0");
					put(grammarAccess.getVLSFunctionAccess().getGroup_2(), "rule__VLSFunction__Group_2__0");
					put(grammarAccess.getVLSFunctionAccess().getGroup_2_2(), "rule__VLSFunction__Group_2_2__0");
					...
					put(grammarAccess.getVLSAnnotationAccess().getNameAssignment_0(), "rule__VLSAnnotation__NameAssignment_0");
					put(grammarAccess.getVLSAnnotationAccess().getClosure_ruleAssignment_1(), "rule__VLSAnnotation__Closure_ruleAssignment_1");
					put(grammarAccess.getClosure_RuleAccess().getNameAssignment_0(), "rule__Closure_Rule__NameAssignment_0");
					...
					put(grammarAccess.getVLSFunctionAccess().getConstantAssignment_1(), "rule__VLSFunction__ConstantAssignment_1");
					put(grammarAccess.getVLSFunctionAccess().getTermsAssignment_2_1(), "rule__VLSFunction__TermsAssignment_2_1");
					put(grammarAccess.getVLSFunctionAccess().getTermsAssignment_2_2_1(), "rule__VLSFunction__TermsAssignment_2_2_1");
					put(grammarAccess.getVLSVariableAccess().getNameAssignment(), "rule__VLSVariable__NameAssignment");
					put(grammarAccess.getVLSFunctionFofAccess().getNameAssignment_0(), "rule__VLSFunctionFof__NameAssignment_0");
					...
					put(grammarAccess.getVLSDefinedTermAccess().getNameAssignment(), "rule__VLSDefinedTerm__NameAssignment");
				}
			};
		}
