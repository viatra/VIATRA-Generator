		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVLSFunctionDeclarationAccess().getNameAlternatives_0(), "rule__VLSFunctionDeclaration__NameAlternatives_0");
					...
					put(grammarAccess.getVLSFunctionDeclarationAccess().getNameAssignment(), "rule__VLSFunctionDeclaration__NameAssignment");
