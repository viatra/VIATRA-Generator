 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.dslreasoner.vampireLanguage.impl.VLSFofFormulaImpl#getName <em>Name</em>}</li>
 *   <li>{@link hu.bme.mit.inf.dslreasoner.vampireLanguage.impl.VLSFofFormulaImpl#getFofRole <em>Fof Role</em>}</li>
 *   <li>{@link hu.bme.mit.inf.dslreasoner.vampireLanguage.impl.VLSFofFormulaImpl#getFofFormula <em>Fof Formula</em>}</li>
 *   <li>{@link hu.bme.mit.inf.dslreasoner.vampireLanguage.impl.VLSFofFormulaImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VLSFofFormulaImpl extends MinimalEObjectImpl.Container implements VLSFofFormula
{
   ...
   * @ordered
   */
  protected static final VLSRole FOF_ROLE_EDEFAULT = VLSRole.AXIOM;
   ...
   * @ordered
   */
  protected VLSRole fofRole = FOF_ROLE_EDEFAULT;
   ...
   * @generated
   */
  public void setFofRole(VLSRole newFofRole)
  {
    VLSRole oldFofRole = fofRole;
    fofRole = newFofRole == null ? FOF_ROLE_EDEFAULT : newFofRole;
    if (eNotificationRequired())
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case VampireLanguagePackage.VLS_FOF_FORMULA__FOF_ROLE:
        return fofRole != FOF_ROLE_EDEFAULT;
      case VampireLanguagePackage.VLS_FOF_FORMULA__FOF_FORMULA:
