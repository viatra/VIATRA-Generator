...
interface Logic2VampireLanguageMapper_TypeMapper {
	...
	def List<VLSSignatureDeclaration> transformTypeReference(Type referred, Logic2VampireLanguageMapper mapper, Logic2VampireLanguageMapperTrace trace)
	def VLSSignatureDeclaration getUndefinedSupertype(Logic2VampireLanguageMapperTrace trace)
