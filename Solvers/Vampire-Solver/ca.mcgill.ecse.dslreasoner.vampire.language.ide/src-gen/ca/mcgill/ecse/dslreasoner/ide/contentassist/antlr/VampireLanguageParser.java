		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVLSTffFormulaAccess().getNameAlternatives_2_0(), "rule__VLSTffFormula__NameAlternatives_2_0");
					...
					put(grammarAccess.getVLSTffFormulaAccess().getGroup_7(), "rule__VLSTffFormula__Group_7__0");
					...
					put(grammarAccess.getVampireModelAccess().getConfirmationsAssignment_2(), "rule__VampireModel__ConfirmationsAssignment_2");
					...
					put(grammarAccess.getVLSTffFormulaAccess().getNameAssignment_2(), "rule__VLSTffFormula__NameAssignment_2");
					put(grammarAccess.getVLSTffFormulaAccess().getFofRoleAssignment_4(), "rule__VLSTffFormula__FofRoleAssignment_4");
