 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.dslreasoner.viatrasolver.partialinterpretationlanguage.partialinterpretation.impl.BooleanElementImpl#isValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanElementImpl extends PrimitiveElementImpl implements BooleanElement {
	...
	protected EClass eStaticClass() {
		return PartialinterpretationPackage.Literals.BOOLEAN_ELEMENT;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PartialinterpretationPackage.BOOLEAN_ELEMENT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PartialinterpretationPackage.BOOLEAN_ELEMENT__VALUE:
				return isValue();
		}
