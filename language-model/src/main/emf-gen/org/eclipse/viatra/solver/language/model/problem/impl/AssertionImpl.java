...
public class AssertionImpl extends MinimalEObjectImpl.Container implements Assertion {
		...
		if (relation != null && relation.eIsProxy()) {
			...
			if (relation != oldRelation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProblemPackage.ASSERTION__RELATION,
	...
	public void setRelation(Relation newRelation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProblemPackage.ASSERTION__RELATION, oldRelation,
					relation));
	}
	...
	public void setValue(LogicValue newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProblemPackage.ASSERTION__VALUE, oldValue, value));
	}
