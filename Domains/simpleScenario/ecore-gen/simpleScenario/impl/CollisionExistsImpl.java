 ...
 * </p>
 * <ul>
 *   <li>{@link simpleScenario.impl.CollisionExistsImpl#getCollisionTime <em>Collision Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollisionExistsImpl extends TemporalRelationImpl implements CollisionExists {
	...
	protected EClass eStaticClass() {
		return SimpleScenarioPackage.Literals.COLLISION_EXISTS;
	}
	...
	public void setCollisionTime(double newCollisionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleScenarioPackage.COLLISION_EXISTS__COLLISION_TIME, oldCollisionTime, collisionTime));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleScenarioPackage.COLLISION_EXISTS__COLLISION_TIME:
