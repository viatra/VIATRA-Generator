 ...
 * </p>
 * <ul>
 *   <li>{@link simpleScenario.impl.VisionBlockedImpl#getBlockedBy <em>Blocked By</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VisionBlockedImpl extends SpatialRelationImpl implements VisionBlocked {
	...
	protected EClass eStaticClass() {
		return SimpleScenarioPackage.Literals.VISION_BLOCKED;
	}
		...
		if (blockedBy != null && blockedBy.eIsProxy()) {
			...
			if (blockedBy != oldBlockedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleScenarioPackage.VISION_BLOCKED__BLOCKED_BY, oldBlockedBy, blockedBy));
			}
		}
		return blockedBy;
	}
	...
	public void setBlockedBy(Actor newBlockedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleScenarioPackage.VISION_BLOCKED__BLOCKED_BY, oldBlockedBy, blockedBy));
	}
