...
import hu.bme.mit.inf.dslreasomer.domains.transima.fam.FunctionalArchitecture.Function;
import hu.bme.mit.inf.dslreasomer.domains.transima.fam.FunctionalArchitecture.FunctionType;
import hu.bme.mit.inf.dslreasomer.domains.transima.fam.FunctionalArchitecture.FunctionalArchitectureFactory;
...
public class FunctionalArchitecturePackageImpl extends EPackageImpl implements FunctionalArchitecturePackage {
	 ...
	 * @see hu.bme.mit.inf.dslreasomer.domains.transima.fam.FunctionalArchitecture.FunctionalArchitecturePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void createOrgAnnotations() {
		...
		addAnnotation
		  (getFunctionalElement_Model(), 
		   source, 
		   new String[] {
			 "patternFQN", "hu.bme.mit.inf.dslreasoner.domains.transima.fam.patterns.model"
		   });	
		addAnnotation
		  (getFunction_Type(), 
		   source, 
		   new String[] {
			 "patternFQN", "hu.bme.mit.inf.dslreasoner.domains.transima.fam.patterns.type"
		   });
	}
