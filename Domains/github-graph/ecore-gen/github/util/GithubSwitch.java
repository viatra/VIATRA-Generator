...
public class GithubSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GithubPackage.ISSUE: {
				Issue issue = (Issue)theEObject;
				T result = caseIssue(issue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GithubPackage.PULL_REQUEST: {
				PullRequest pullRequest = (PullRequest)theEObject;
				T result = casePullRequest(pullRequest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GithubPackage.ISSUE_EVENT: {
	 ...
	 * @generated
	 */
	public T casePullRequest(PullRequest object) {
		return null;
	}
