 ...
 * @generated
 */
public class SmartgridSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SmartgridPackage.CONCENTRATOR: {
			...
			if (result == null)
				result = caseEntity(concentrator);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SmartgridPackage.SMART_METER: {
			...
			if (result == null)
				result = caseMeter(smartMeter);
			if (result == null)
				result = caseEntity(smartMeter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
