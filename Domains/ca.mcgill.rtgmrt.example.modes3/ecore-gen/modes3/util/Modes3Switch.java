 ...
 * @generated
 */
public class Modes3Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Modes3Package.SEGMENT: {
				Segment segment = (Segment)theEObject;
				T result = caseSegment(segment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Modes3Package.MODES3_MODEL_ROOT: {
				Modes3ModelRoot modes3ModelRoot = (Modes3ModelRoot)theEObject;
				T result = caseModes3ModelRoot(modes3ModelRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Modes3Package.TURNOUT: {
				Turnout turnout = (Turnout)theEObject;
				T result = caseTurnout(turnout);
				if (result == null) result = caseSegment(turnout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Modes3Package.TRAIN: {
	 ...
	 * @generated
	 */
	public T caseModes3ModelRoot(Modes3ModelRoot object) {
		return null;
	}
