...
class SubtractionTest {
	...
	static def Collection<Object[]> data() {
		#[
			...
			#[upTo(2), upTo(1), UNBOUNDED],
			#[upTo(2), above(-1), upTo(3)],
			#[upTo(2), between(-1, 2), upTo(3)],
			#[above(-2), UNBOUNDED, UNBOUNDED],
			#[above(-2), upTo(1), above(-3)],
			#[above(-2), above(-1), UNBOUNDED],
			#[above(-2), between(-1, 2), above(-4)],
			#[between(-2, 3), UNBOUNDED, UNBOUNDED],
			#[between(-2, 3), upTo(1), above(-3)],
			#[between(-2, 3), above(-1), upTo(4)],
			#[between(-2, 3), between(-1, 2.5), between(-4.5, 4)]
		]
	}
