...
public class SatelliteSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SatellitePackage.INTERFEROMETRY_MISSION: {
				...
				if (result == null) result = caseConstellationMission(interferometryMission);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SatellitePackage.GROUND_STATION_NETWORK: {
				...
				if (result == null) result = caseCommunicatingElement(groundStationNetwork);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SatellitePackage.SPACECRAFT: {
				...
				if (result == null) result = caseCommunicatingElement(spacecraft);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SatellitePackage.INTERFEROMETRY_PAYLOAD: {
				...
				if (result == null) result = casePayload(interferometryPayload);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SatellitePackage.CUBE_SAT3_U: {
				...
				if (result == null) result = caseCubeSat(cubeSat3U);
				if (result == null) result = caseSpacecraft(cubeSat3U);
				if (result == null) result = caseCommunicatingElement(cubeSat3U);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SatellitePackage.CUBE_SAT6_U: {
				...
				if (result == null) result = caseCubeSat(cubeSat6U);
				if (result == null) result = caseSpacecraft(cubeSat6U);
				if (result == null) result = caseCommunicatingElement(cubeSat6U);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SatellitePackage.SMALL_SAT: {
				...
				if (result == null) result = caseSpacecraft(smallSat);
				if (result == null) result = caseCommunicatingElement(smallSat);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SatellitePackage.CUBE_SAT: {
				...
				if (result == null) result = caseSpacecraft(cubeSat);
				if (result == null) result = caseCommunicatingElement(cubeSat);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SatellitePackage.UHF_COMM_SUBSYSTEM: {
				UHFCommSubsystem uhfCommSubsystem = (UHFCommSubsystem)theEObject;
				T result = caseUHFCommSubsystem(uhfCommSubsystem);
				if (result == null) result = caseCommSubsystem(uhfCommSubsystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SatellitePackage.XCOMM_SUBSYSTEM: {
				XCommSubsystem xCommSubsystem = (XCommSubsystem)theEObject;
				T result = caseXCommSubsystem(xCommSubsystem);
				if (result == null) result = caseCommSubsystem(xCommSubsystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SatellitePackage.KA_COMM_SUBSYSTEM: {
				KaCommSubsystem kaCommSubsystem = (KaCommSubsystem)theEObject;
				T result = caseKaCommSubsystem(kaCommSubsystem);
				if (result == null) result = caseCommSubsystem(kaCommSubsystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>UHF Comm Subsystem</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>UHF Comm Subsystem</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUHFCommSubsystem(UHFCommSubsystem object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>XComm Subsystem</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>XComm Subsystem</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseXCommSubsystem(XCommSubsystem object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ka Comm Subsystem</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ka Comm Subsystem</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseKaCommSubsystem(KaCommSubsystem object) {
		return null;
	}
