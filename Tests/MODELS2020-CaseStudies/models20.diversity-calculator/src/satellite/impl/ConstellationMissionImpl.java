 ...
 * </p>
 * <ul>
 *   <li>{@link satellite.impl.ConstellationMissionImpl#getGroundStationNetwork <em>Ground Station Network</em>}</li>
 *   <li>{@link satellite.impl.ConstellationMissionImpl#getSpacecraft <em>Spacecraft</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConstellationMissionImpl extends MinimalEObjectImpl.Container implements ConstellationMission {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetGroundStationNetwork(GroundStationNetwork newGroundStationNetwork, NotificationChain msgs) {
		GroundStationNetwork oldGroundStationNetwork = groundStationNetwork;
		groundStationNetwork = newGroundStationNetwork;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SatellitePackage.CONSTELLATION_MISSION__GROUND_STATION_NETWORK, oldGroundStationNetwork, newGroundStationNetwork);
	...
	public void setGroundStationNetwork(GroundStationNetwork newGroundStationNetwork) {
		if (newGroundStationNetwork != groundStationNetwork) {
			...
			if (groundStationNetwork != null)
				msgs = ((InternalEObject)groundStationNetwork).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SatellitePackage.CONSTELLATION_MISSION__GROUND_STATION_NETWORK, null, msgs);
			if (newGroundStationNetwork != null)
				msgs = ((InternalEObject)newGroundStationNetwork).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SatellitePackage.CONSTELLATION_MISSION__GROUND_STATION_NETWORK, null, msgs);
			msgs = basicSetGroundStationNetwork(newGroundStationNetwork, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SatellitePackage.CONSTELLATION_MISSION__GROUND_STATION_NETWORK, newGroundStationNetwork, newGroundStationNetwork));
	}
	...
	public EList<Spacecraft> getSpacecraft() {
		if (spacecraft == null) {
			spacecraft = new EObjectContainmentEList<Spacecraft>(Spacecraft.class, this, SatellitePackage.CONSTELLATION_MISSION__SPACECRAFT);
		}
		return spacecraft;
	}
