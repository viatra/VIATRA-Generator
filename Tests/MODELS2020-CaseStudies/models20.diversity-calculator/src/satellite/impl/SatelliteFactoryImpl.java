...
public class SatelliteFactoryImpl extends EFactoryImpl implements SatelliteFactory {
	...
	public static SatelliteFactory init() {
		try {
			SatelliteFactory theSatelliteFactory = (SatelliteFactory)EPackage.Registry.INSTANCE.getEFactory(SatellitePackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SatellitePackage.INTERFEROMETRY_MISSION: return createInterferometryMission();
			case SatellitePackage.GROUND_STATION_NETWORK: return createGroundStationNetwork();
			case SatellitePackage.INTERFEROMETRY_PAYLOAD: return createInterferometryPayload();
			case SatellitePackage.CUBE_SAT3_U: return createCubeSat3U();
			case SatellitePackage.CUBE_SAT6_U: return createCubeSat6U();
			case SatellitePackage.SMALL_SAT: return createSmallSat();
			case SatellitePackage.UHF_COMM_SUBSYSTEM: return createUHFCommSubsystem();
			case SatellitePackage.XCOMM_SUBSYSTEM: return createXCommSubsystem();
			case SatellitePackage.KA_COMM_SUBSYSTEM: return createKaCommSubsystem();
			default:
