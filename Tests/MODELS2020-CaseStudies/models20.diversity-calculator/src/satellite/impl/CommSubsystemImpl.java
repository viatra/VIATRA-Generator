...
public abstract class CommSubsystemImpl extends MinimalEObjectImpl.Container implements CommSubsystem {
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SatellitePackage.COMM_SUBSYSTEM__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(CommSubsystem newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SatellitePackage.COMM_SUBSYSTEM__TARGET, oldTarget, target));
	}
	...
	public void setFrequency(int newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SatellitePackage.COMM_SUBSYSTEM__FREQUENCY, oldFrequency, frequency));
	}
	...
	public void setPathLength(int newPathLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SatellitePackage.COMM_SUBSYSTEM__PATH_LENGTH, oldPathLength, pathLength));
	}
