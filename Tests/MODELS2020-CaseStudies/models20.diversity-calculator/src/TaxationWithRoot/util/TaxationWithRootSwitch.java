 ...
 * @generated
 */
public class TaxationWithRootSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TaxationWithRootPackage.HABITUAL_ADDRESS: {
			...
			case TaxationWithRootPackage.MARRIAGE_RECORD: {
			...
			case TaxationWithRootPackage.NON_RESIDENT_TAX_PAYER: {
			...
			case TaxationWithRootPackage.PARTNERSHIP_RECORD: {
			...
			case TaxationWithRootPackage.RESIDENT_TAX_PAYER: {
			...
			case TaxationWithRootPackage.TRADE_AND_BUSINESS_INCOME: {
			...
			case TaxationWithRootPackage.AGRICULTURE_AND_FORESTRY_INCOME: {
			...
			case TaxationWithRootPackage.PENSIONS_AND_ANNUITIES_INCOME: {
			...
			case TaxationWithRootPackage.CAPITAL_AND_INVESTMENTS_INCOME: {
			...
			case TaxationWithRootPackage.EMPLOYMENT_INCOME: {
			...
			case TaxationWithRootPackage.RENTALS_AND_LEASES_INCOME: {
			...
			case TaxationWithRootPackage.FOREIGN_INCOME: {
			...
			case TaxationWithRootPackage.LOCAL_INCOME: {
			...
			case TaxationWithRootPackage.CIM: {
			...
			case TaxationWithRootPackage.CIP: {
			...
			case TaxationWithRootPackage.CIS: {
			...
			case TaxationWithRootPackage.PERMANENT_EXPENSE: {
			...
			case TaxationWithRootPackage.SPECIAL_EXPENSE_DS: {
			...
			case TaxationWithRootPackage.INTEREST_EXPENSE: {
			...
			case TaxationWithRootPackage.PRIVATE_INSURANCE_AND_PLAN: {
			...
			case TaxationWithRootPackage.HEALTH_AND_PENSION_INSURANCE: {
			...
			case TaxationWithRootPackage.DONATION: {
			...
			case TaxationWithRootPackage.LOSS_CARRYFORWARD: {
			...
			case TaxationWithRootPackage.SPOUSAL_EXPENSE_AC: {
			...
			case TaxationWithRootPackage.EXTRAORDINARY_EXPENSE_CE: {
			...
			case TaxationWithRootPackage.TRAVEL_EXPENSE_FD: {
			...
			case TaxationWithRootPackage.PROFESSIONAL_EXPENSE: {
			...
			case TaxationWithRootPackage.MISCELLANEOUS_EXPENSE_FO: {
			...
			case TaxationWithRootPackage.RESOURCE: {
