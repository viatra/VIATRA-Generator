 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.Income_Tax_Credit#getGrantedBy <em>Granted By</em>}</li>
 *   <li>{@link TaxationWithRoot.Income_Tax_Credit#getTaxPayer <em>Tax Payer</em>}</li>
 *   <li>{@link TaxationWithRoot.Income_Tax_Credit#getTax_year <em>Tax year</em>}</li>
 *   <li>{@link TaxationWithRoot.Income_Tax_Credit#getYearly <em>Yearly</em>}</li>
 *   <li>{@link TaxationWithRoot.Income_Tax_Credit#getMonthly <em>Monthly</em>}</li>
 *   <li>{@link TaxationWithRoot.Income_Tax_Credit#getDaily <em>Daily</em>}</li>
 *   <li>{@link TaxationWithRoot.Income_Tax_Credit#getId7 <em>Id7</em>}</li>
 *   <li>{@link TaxationWithRoot.Income_Tax_Credit#getTaxation_Frame <em>Taxation Frame</em>}</li>
 * </ul>
 *
 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit()
 * @model
 * @generated
 */
public interface Income_Tax_Credit extends EObject {
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit_GrantedBy()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link TaxationWithRoot.Income_Tax_Credit#getGrantedBy <em>Granted By</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit_TaxPayer()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link TaxationWithRoot.Income_Tax_Credit#getTaxPayer <em>Tax Payer</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTax_year(int)
	 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit_Tax_year()
	 * @model required="true"
	 * @generated
	 */
	int getTax_year();
	...
	/**
	 * Sets the value of the '{@link TaxationWithRoot.Income_Tax_Credit#getTax_year <em>Tax year</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit_Yearly()
	...
	/**
	 * Sets the value of the '{@link TaxationWithRoot.Income_Tax_Credit#getYearly <em>Yearly</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit_Monthly()
	...
	/**
	 * Sets the value of the '{@link TaxationWithRoot.Income_Tax_Credit#getMonthly <em>Monthly</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setDaily(double)
	 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit_Daily()
	...
	/**
	 * Sets the value of the '{@link TaxationWithRoot.Income_Tax_Credit#getDaily <em>Daily</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setId7(String)
	 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit_Id7()
	...
	/**
	 * Sets the value of the '{@link TaxationWithRoot.Income_Tax_Credit#getId7 <em>Id7</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link TaxationWithRoot.Tax_Card#getIncome_Tax_Credit <em>Income Tax Credit</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Taxation Frame</em>' reference.
	 * @see #setTaxation_Frame(Tax_Card)
	 * @see TaxationWithRoot.TaxationWithRootPackage#getIncome_Tax_Credit_Taxation_Frame()
	...
	/**
	 * Sets the value of the '{@link TaxationWithRoot.Income_Tax_Credit#getTaxation_Frame <em>Taxation Frame</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
