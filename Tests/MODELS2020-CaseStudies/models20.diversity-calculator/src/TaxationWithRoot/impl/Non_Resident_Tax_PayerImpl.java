 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.Non_Resident_Tax_PayerImpl#isIs_assimilated_to_resident <em>Is assimilated to resident</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Non_Resident_Tax_PayerImpl extends Tax_PayerImpl implements Non_Resident_Tax_Payer {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.NON_RESIDENT_TAX_PAYER;
	}
	...
	public void setIs_assimilated_to_resident(boolean newIs_assimilated_to_resident) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.NON_RESIDENT_TAX_PAYER__IS_ASSIMILATED_TO_RESIDENT, oldIs_assimilated_to_resident, is_assimilated_to_resident));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.NON_RESIDENT_TAX_PAYER__IS_ASSIMILATED_TO_RESIDENT:
