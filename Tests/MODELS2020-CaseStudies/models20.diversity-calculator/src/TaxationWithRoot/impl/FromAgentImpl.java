 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.FromAgentImpl#getTaxPayer <em>Tax Payer</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.FromAgentImpl#isIs_dependent_eligible_for_CE_Not_In_Houshold_Children_Care <em>Is dependent eligible for CE Not In Houshold Children Care</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.FromAgentImpl#getExpense <em>Expense</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.FromAgentImpl#isIs_eligible_debt <em>Is eligible debt</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.FromAgentImpl#getDependent <em>Dependent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FromAgentImpl extends MinimalEObjectImpl.Container implements FromAgent {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.FROM_AGENT;
	}
	...
	public Tax_Payer getTaxPayer() {
		if (eContainerFeatureID() != TaxationWithRootPackage.FROM_AGENT__TAX_PAYER) return null;
	...
	public NotificationChain basicSetTaxPayer(Tax_Payer newTaxPayer, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTaxPayer, TaxationWithRootPackage.FROM_AGENT__TAX_PAYER, msgs);
		return msgs;
	}
	...
	public void setTaxPayer(Tax_Payer newTaxPayer) {
		if (newTaxPayer != eInternalContainer() || (eContainerFeatureID() != TaxationWithRootPackage.FROM_AGENT__TAX_PAYER && newTaxPayer != null)) {
			...
			if (newTaxPayer != null)
				msgs = ((InternalEObject)newTaxPayer).eInverseAdd(this, TaxationWithRootPackage.TAX_PAYER__FROM_AGENT, Tax_Payer.class, msgs);
			msgs = basicSetTaxPayer(newTaxPayer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.FROM_AGENT__TAX_PAYER, newTaxPayer, newTaxPayer));
	}
	...
	public void setIs_dependent_eligible_for_CE_Not_In_Houshold_Children_Care(boolean newIs_dependent_eligible_for_CE_Not_In_Houshold_Children_Care) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.FROM_AGENT__IS_DEPENDENT_ELIGIBLE_FOR_CE_NOT_IN_HOUSHOLD_CHILDREN_CARE, oldIs_dependent_eligible_for_CE_Not_In_Houshold_Children_Care, is_dependent_eligible_for_CE_Not_In_Houshold_Children_Care));
	}
	...
	public Expense getExpense() {
		if (expense != null && expense.eIsProxy()) {
			...
			if (expense != oldExpense) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaxationWithRootPackage.FROM_AGENT__EXPENSE, oldExpense, expense));
			}
		}
		return expense;
	}
	...
	public NotificationChain basicSetExpense(Expense newExpense, NotificationChain msgs) {
		...
		expense = newExpense;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.FROM_AGENT__EXPENSE, oldExpense, newExpense);
	...
	public void setExpense(Expense newExpense) {
		if (newExpense != expense) {
			NotificationChain msgs = null;
			if (expense != null)
				msgs = ((InternalEObject)expense).eInverseRemove(this, TaxationWithRootPackage.EXPENSE__FROM_AGENT, Expense.class, msgs);
			if (newExpense != null)
				msgs = ((InternalEObject)newExpense).eInverseAdd(this, TaxationWithRootPackage.EXPENSE__FROM_AGENT, Expense.class, msgs);
			msgs = basicSetExpense(newExpense, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.FROM_AGENT__EXPENSE, newExpense, newExpense));
	}
	...
	public void setIs_eligible_debt(boolean newIs_eligible_debt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.FROM_AGENT__IS_ELIGIBLE_DEBT, oldIs_eligible_debt, is_eligible_debt));
	}
	...
	public Dependent getDependent() {
		if (dependent != null && dependent.eIsProxy()) {
			...
			if (dependent != oldDependent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaxationWithRootPackage.FROM_AGENT__DEPENDENT, oldDependent, dependent));
			}
		}
		return dependent;
	}
	...
	public NotificationChain basicSetDependent(Dependent newDependent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.FROM_AGENT__DEPENDENT, oldDependent, newDependent);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDependent(Dependent newDependent) {
		if (newDependent != dependent) {
			NotificationChain msgs = null;
			if (dependent != null)
				msgs = ((InternalEObject)dependent).eInverseRemove(this, TaxationWithRootPackage.DEPENDENT__FROM_AGENT, Dependent.class, msgs);
			if (newDependent != null)
				msgs = ((InternalEObject)newDependent).eInverseAdd(this, TaxationWithRootPackage.DEPENDENT__FROM_AGENT, Dependent.class, msgs);
			msgs = basicSetDependent(newDependent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.FROM_AGENT__DEPENDENT, newDependent, newDependent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.FROM_AGENT__TAX_PAYER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetTaxPayer((Tax_Payer)otherEnd, msgs);
			case TaxationWithRootPackage.FROM_AGENT__EXPENSE:
				if (expense != null)
					msgs = ((InternalEObject)expense).eInverseRemove(this, TaxationWithRootPackage.EXPENSE__FROM_AGENT, Expense.class, msgs);
				return basicSetExpense((Expense)otherEnd, msgs);
			case TaxationWithRootPackage.FROM_AGENT__DEPENDENT:
				if (dependent != null)
					msgs = ((InternalEObject)dependent).eInverseRemove(this, TaxationWithRootPackage.DEPENDENT__FROM_AGENT, Dependent.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TaxationWithRootPackage.FROM_AGENT__TAX_PAYER:
				return eInternalContainer().eInverseRemove(this, TaxationWithRootPackage.TAX_PAYER__FROM_AGENT, Tax_Payer.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.FROM_AGENT__TAX_PAYER:
				return getTaxPayer();
			case TaxationWithRootPackage.FROM_AGENT__IS_DEPENDENT_ELIGIBLE_FOR_CE_NOT_IN_HOUSHOLD_CHILDREN_CARE:
				return isIs_dependent_eligible_for_CE_Not_In_Houshold_Children_Care();
			case TaxationWithRootPackage.FROM_AGENT__EXPENSE:
				if (resolve) return getExpense();
				return basicGetExpense();
			case TaxationWithRootPackage.FROM_AGENT__IS_ELIGIBLE_DEBT:
