...
public class Income_Tax_CreditImpl extends MinimalEObjectImpl.Container implements Income_Tax_Credit {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.INCOME_TAX_CREDIT;
	}
	...
	public void setGrantedBy(Grantor newGrantedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__GRANTED_BY, oldGrantedBy, grantedBy));
	}
	...
	public Tax_Payer getTaxPayer() {
		if (taxPayer != null && taxPayer.eIsProxy()) {
			...
			if (taxPayer != oldTaxPayer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaxationWithRootPackage.INCOME_TAX_CREDIT__TAX_PAYER, oldTaxPayer, taxPayer));
			}
		}
		return taxPayer;
	}
	...
	public void setTaxPayer(Tax_Payer newTaxPayer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__TAX_PAYER, oldTaxPayer, taxPayer));
	}
	...
	public void setTax_year(int newTax_year) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__TAX_YEAR, oldTax_year, tax_year));
	}
	...
	public void setYearly(double newYearly) {
		...
		yearly = newYearly;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__YEARLY, oldYearly, yearly));
	}
	...
	public void setMonthly(double newMonthly) {
		...
		monthly = newMonthly;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__MONTHLY, oldMonthly, monthly));
	}
	...
	public void setDaily(double newDaily) {
		...
		daily = newDaily;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__DAILY, oldDaily, daily));
	}
	...
	public void setId7(String newId7) {
		...
		id7 = newId7;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__ID7, oldId7, id7));
	}
	...
	public Tax_Card getTaxation_Frame() {
		if (taxation_Frame != null && taxation_Frame.eIsProxy()) {
			...
			if (taxation_Frame != oldTaxation_Frame) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaxationWithRootPackage.INCOME_TAX_CREDIT__TAXATION_FRAME, oldTaxation_Frame, taxation_Frame));
			}
		}
	...
	public NotificationChain basicSetTaxation_Frame(Tax_Card newTaxation_Frame, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__TAXATION_FRAME, oldTaxation_Frame, newTaxation_Frame);
	...
	public void setTaxation_Frame(Tax_Card newTaxation_Frame) {
		if (newTaxation_Frame != taxation_Frame) {
			...
			if (taxation_Frame != null)
				msgs = ((InternalEObject)taxation_Frame).eInverseRemove(this, TaxationWithRootPackage.TAX_CARD__INCOME_TAX_CREDIT, Tax_Card.class, msgs);
			if (newTaxation_Frame != null)
				msgs = ((InternalEObject)newTaxation_Frame).eInverseAdd(this, TaxationWithRootPackage.TAX_CARD__INCOME_TAX_CREDIT, Tax_Card.class, msgs);
			msgs = basicSetTaxation_Frame(newTaxation_Frame, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX_CREDIT__TAXATION_FRAME, newTaxation_Frame, newTaxation_Frame));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__TAXATION_FRAME:
				if (taxation_Frame != null)
					msgs = ((InternalEObject)taxation_Frame).eInverseRemove(this, TaxationWithRootPackage.TAX_CARD__INCOME_TAX_CREDIT, Tax_Card.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__GRANTED_BY:
				return getGrantedBy();
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__TAX_PAYER:
				if (resolve) return getTaxPayer();
				return basicGetTaxPayer();
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__TAX_YEAR:
				return getTax_year();
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__YEARLY:
				return getYearly();
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__MONTHLY:
				return getMonthly();
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__DAILY:
				return getDaily();
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__ID7:
				return getId7();
			case TaxationWithRootPackage.INCOME_TAX_CREDIT__TAXATION_FRAME:
