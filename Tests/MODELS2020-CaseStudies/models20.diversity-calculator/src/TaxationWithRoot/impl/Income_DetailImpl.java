 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.Income_DetailImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_DetailImpl#isIs_worked <em>Is worked</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_DetailImpl#getDistance <em>Distance</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_DetailImpl#getWorked_days <em>Worked days</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_DetailImpl#isIs_contributing_CNS <em>Is contributing CNS</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_DetailImpl#getId5 <em>Id5</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_DetailImpl#getIncome <em>Income</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Income_DetailImpl extends MinimalEObjectImpl.Container implements Income_Detail {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.INCOME_DETAIL;
	}
	...
	public void setAmount(double newAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_DETAIL__AMOUNT, oldAmount, amount));
	}
	...
	public void setIs_worked(boolean newIs_worked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_DETAIL__IS_WORKED, oldIs_worked, is_worked));
	}
	...
	public void setDistance(double newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_DETAIL__DISTANCE, oldDistance, distance));
	}
	...
	public void setWorked_days(int newWorked_days) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_DETAIL__WORKED_DAYS, oldWorked_days, worked_days));
	}
	...
	public void setIs_contributing_CNS(boolean newIs_contributing_CNS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_DETAIL__IS_CONTRIBUTING_CNS, oldIs_contributing_CNS, is_contributing_CNS));
	}
	...
	public void setId5(String newId5) {
		...
		id5 = newId5;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_DETAIL__ID5, oldId5, id5));
	}
	...
	public Income getIncome() {
		if (eContainerFeatureID() != TaxationWithRootPackage.INCOME_DETAIL__INCOME) return null;
	...
	public NotificationChain basicSetIncome(Income newIncome, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newIncome, TaxationWithRootPackage.INCOME_DETAIL__INCOME, msgs);
		return msgs;
	}
	...
	public void setIncome(Income newIncome) {
		if (newIncome != eInternalContainer() || (eContainerFeatureID() != TaxationWithRootPackage.INCOME_DETAIL__INCOME && newIncome != null)) {
			...
			if (newIncome != null)
				msgs = ((InternalEObject)newIncome).eInverseAdd(this, TaxationWithRootPackage.INCOME__DETAILS, Income.class, msgs);
			msgs = basicSetIncome(newIncome, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_DETAIL__INCOME, newIncome, newIncome));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.INCOME_DETAIL__INCOME:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TaxationWithRootPackage.INCOME_DETAIL__INCOME:
				return eInternalContainer().eInverseRemove(this, TaxationWithRootPackage.INCOME__DETAILS, Income.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.INCOME_DETAIL__AMOUNT:
				return getAmount();
			case TaxationWithRootPackage.INCOME_DETAIL__IS_WORKED:
				return isIs_worked();
			case TaxationWithRootPackage.INCOME_DETAIL__DISTANCE:
				return getDistance();
			case TaxationWithRootPackage.INCOME_DETAIL__WORKED_DAYS:
				return getWorked_days();
			case TaxationWithRootPackage.INCOME_DETAIL__IS_CONTRIBUTING_CNS:
				return isIs_contributing_CNS();
			case TaxationWithRootPackage.INCOME_DETAIL__ID5:
				return getId5();
			case TaxationWithRootPackage.INCOME_DETAIL__INCOME:
				return getIncome();
		}
