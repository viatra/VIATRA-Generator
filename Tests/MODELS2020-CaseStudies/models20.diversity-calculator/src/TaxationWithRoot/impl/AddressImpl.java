...
public class AddressImpl extends MinimalEObjectImpl.Container implements Address {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.ADDRESS;
	}
	...
	public void setCountry(Country newCountry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.ADDRESS__COUNTRY, oldCountry, country));
	}
	...
	public void setStreet(String newStreet) {
		...
		street = newStreet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.ADDRESS__STREET, oldStreet, street));
	}
	...
	public void setZipCode(String newZipCode) {
		...
		zipCode = newZipCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.ADDRESS__ZIP_CODE, oldZipCode, zipCode));
	}
	...
	public void setCity(String newCity) {
		...
		city = newCity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.ADDRESS__CITY, oldCity, city));
	}
	...
	public void setId2(String newId2) {
		...
		id2 = newId2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.ADDRESS__ID2, oldId2, id2));
	}
	...
	public EList<Physical_Person> getTaxPayer() {
		if (taxPayer == null) {
			taxPayer = new EObjectWithInverseResolvingEList.ManyInverse<Physical_Person>(Physical_Person.class, this, TaxationWithRootPackage.ADDRESS__TAX_PAYER, TaxationWithRootPackage.PHYSICAL_PERSON__ADDRESSES);
		}
		return taxPayer;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.ADDRESS__TAX_PAYER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.ADDRESS__COUNTRY:
				return getCountry();
			case TaxationWithRootPackage.ADDRESS__STREET:
				return getStreet();
			case TaxationWithRootPackage.ADDRESS__ZIP_CODE:
				return getZipCode();
			case TaxationWithRootPackage.ADDRESS__CITY:
				return getCity();
			case TaxationWithRootPackage.ADDRESS__ID2:
				return getId2();
			case TaxationWithRootPackage.ADDRESS__TAX_PAYER:
				return getTaxPayer();
		}
