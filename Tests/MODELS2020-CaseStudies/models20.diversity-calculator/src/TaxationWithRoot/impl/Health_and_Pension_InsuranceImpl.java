 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.Health_and_Pension_InsuranceImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Health_and_Pension_InsuranceImpl#isIs_related_to_additional_salary <em>Is related to additional salary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Health_and_Pension_InsuranceImpl extends Special_Expense_DSImpl implements Health_and_Pension_Insurance {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.HEALTH_AND_PENSION_INSURANCE;
	}
	...
	public void setCategory(Category_of_Health_and_Pension_Insurances newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.HEALTH_AND_PENSION_INSURANCE__CATEGORY, oldCategory, category));
	}
	...
	public void setIs_related_to_additional_salary(boolean newIs_related_to_additional_salary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.HEALTH_AND_PENSION_INSURANCE__IS_RELATED_TO_ADDITIONAL_SALARY, oldIs_related_to_additional_salary, is_related_to_additional_salary));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.HEALTH_AND_PENSION_INSURANCE__CATEGORY:
				return getCategory();
			case TaxationWithRootPackage.HEALTH_AND_PENSION_INSURANCE__IS_RELATED_TO_ADDITIONAL_SALARY:
