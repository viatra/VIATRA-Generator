 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#getStart_year <em>Start year</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#getEnd_year <em>End year</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#getSeparation_cause <em>Separation cause</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#getIndividual_A <em>Individual A</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#getIndividual_B <em>Individual B</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#isMutual_agreement <em>Mutual agreement</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#getId9 <em>Id9</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Legal_Union_RecordImpl#getHousehold <em>Household</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class Legal_Union_RecordImpl extends MinimalEObjectImpl.Container implements Legal_Union_Record {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.LEGAL_UNION_RECORD;
	}
	...
	public void setStart_year(int newStart_year) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.LEGAL_UNION_RECORD__START_YEAR, oldStart_year, start_year));
	}
	...
	public void setEnd_year(int newEnd_year) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.LEGAL_UNION_RECORD__END_YEAR, oldEnd_year, end_year));
	}
	...
	public void setSeparation_cause(Separation_Causes newSeparation_cause) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.LEGAL_UNION_RECORD__SEPARATION_CAUSE, oldSeparation_cause, separation_cause));
	}
	...
	public NotificationChain basicSetIndividual_A(Physical_Person newIndividual_A, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.LEGAL_UNION_RECORD__INDIVIDUAL_A, oldIndividual_A, newIndividual_A);
	...
	public void setIndividual_A(Physical_Person newIndividual_A) {
		if (newIndividual_A != individual_A) {
			...
			if (individual_A != null)
				msgs = ((InternalEObject)individual_A).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TaxationWithRootPackage.LEGAL_UNION_RECORD__INDIVIDUAL_A, null, msgs);
			if (newIndividual_A != null)
				msgs = ((InternalEObject)newIndividual_A).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TaxationWithRootPackage.LEGAL_UNION_RECORD__INDIVIDUAL_A, null, msgs);
			msgs = basicSetIndividual_A(newIndividual_A, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.LEGAL_UNION_RECORD__INDIVIDUAL_A, newIndividual_A, newIndividual_A));
	}
	...
	public EList<Physical_Person> getIndividual_B() {
		if (individual_B == null) {
			individual_B = new EObjectContainmentEList<Physical_Person>(Physical_Person.class, this, TaxationWithRootPackage.LEGAL_UNION_RECORD__INDIVIDUAL_B);
		}
		return individual_B;
	}
	...
	public EList<Tax_Property> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentWithInverseEList<Tax_Property>(Tax_Property.class, this, TaxationWithRootPackage.LEGAL_UNION_RECORD__PROPERTIES, TaxationWithRootPackage.TAX_PROPERTY__UNION_RECORD);
		}
		return properties;
	}
	...
	public void setMutual_agreement(boolean newMutual_agreement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.LEGAL_UNION_RECORD__MUTUAL_AGREEMENT, oldMutual_agreement, mutual_agreement));
	}
	...
	public void setId9(String newId9) {
		...
		id9 = newId9;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.LEGAL_UNION_RECORD__ID9, oldId9, id9));
	}
	...
	public Household getHousehold() {
		if (eContainerFeatureID() != TaxationWithRootPackage.LEGAL_UNION_RECORD__HOUSEHOLD) return null;
	...
	public NotificationChain basicSetHousehold(Household newHousehold, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newHousehold, TaxationWithRootPackage.LEGAL_UNION_RECORD__HOUSEHOLD, msgs);
		return msgs;
	}
	...
	public void setHousehold(Household newHousehold) {
		if (newHousehold != eInternalContainer() || (eContainerFeatureID() != TaxationWithRootPackage.LEGAL_UNION_RECORD__HOUSEHOLD && newHousehold != null)) {
			...
			if (newHousehold != null)
				msgs = ((InternalEObject)newHousehold).eInverseAdd(this, TaxationWithRootPackage.HOUSEHOLD__PARENTS, Household.class, msgs);
			msgs = basicSetHousehold(newHousehold, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.LEGAL_UNION_RECORD__HOUSEHOLD, newHousehold, newHousehold));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__PROPERTIES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getProperties()).basicAdd(otherEnd, msgs);
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__HOUSEHOLD:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__INDIVIDUAL_A:
				return basicSetIndividual_A(null, msgs);
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__INDIVIDUAL_B:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__HOUSEHOLD:
				return eInternalContainer().eInverseRemove(this, TaxationWithRootPackage.HOUSEHOLD__PARENTS, Household.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__START_YEAR:
				return getStart_year();
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__END_YEAR:
				return getEnd_year();
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__SEPARATION_CAUSE:
			...
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__MUTUAL_AGREEMENT:
				return isMutual_agreement();
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__ID9:
				return getId9();
			case TaxationWithRootPackage.LEGAL_UNION_RECORD__HOUSEHOLD:
				return getHousehold();
		}
