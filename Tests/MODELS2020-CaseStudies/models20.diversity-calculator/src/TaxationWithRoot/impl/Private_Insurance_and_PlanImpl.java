 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.Private_Insurance_and_PlanImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Private_Insurance_and_PlanImpl#getDuration_of_contract <em>Duration of contract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Private_Insurance_and_PlanImpl extends Special_Expense_DSImpl implements Private_Insurance_and_Plan {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.PRIVATE_INSURANCE_AND_PLAN;
	}
	...
	public void setCategory(Category_of_Private_Insurance_and_Plan newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.PRIVATE_INSURANCE_AND_PLAN__CATEGORY, oldCategory, category));
	}
	...
	public void setDuration_of_contract(int newDuration_of_contract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.PRIVATE_INSURANCE_AND_PLAN__DURATION_OF_CONTRACT, oldDuration_of_contract, duration_of_contract));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.PRIVATE_INSURANCE_AND_PLAN__CATEGORY:
				return getCategory();
			case TaxationWithRootPackage.PRIVATE_INSURANCE_AND_PLAN__DURATION_OF_CONTRACT:
