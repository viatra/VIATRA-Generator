...
public class Rentals_and_Leases_IncomeImpl extends Income_TypeImpl implements Rentals_and_Leases_Income {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.RENTALS_AND_LEASES_INCOME;
	}
	...
	public void setIs_periodic(boolean newIs_periodic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.RENTALS_AND_LEASES_INCOME__IS_PERIODIC, oldIs_periodic, is_periodic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.RENTALS_AND_LEASES_INCOME__IS_PERIODIC:
