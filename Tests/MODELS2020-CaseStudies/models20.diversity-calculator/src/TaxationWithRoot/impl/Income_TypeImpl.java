...
public abstract class Income_TypeImpl extends MinimalEObjectImpl.Container implements Income_Type {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.INCOME_TYPE;
	}
	...
	public void setId8(String newId8) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TYPE__ID8, oldId8, id8));
	}
	...
	public Income getIncome() {
		if (eContainerFeatureID() != TaxationWithRootPackage.INCOME_TYPE__INCOME) return null;
	...
	public NotificationChain basicSetIncome(Income newIncome, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newIncome, TaxationWithRootPackage.INCOME_TYPE__INCOME, msgs);
		return msgs;
	}
	...
	public void setIncome(Income newIncome) {
		if (newIncome != eInternalContainer() || (eContainerFeatureID() != TaxationWithRootPackage.INCOME_TYPE__INCOME && newIncome != null)) {
			...
			if (newIncome != null)
				msgs = ((InternalEObject)newIncome).eInverseAdd(this, TaxationWithRootPackage.INCOME__INCOME_TYPE, Income.class, msgs);
			msgs = basicSetIncome(newIncome, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TYPE__INCOME, newIncome, newIncome));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.INCOME_TYPE__INCOME:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TaxationWithRootPackage.INCOME_TYPE__INCOME:
				return eInternalContainer().eInverseRemove(this, TaxationWithRootPackage.INCOME__INCOME_TYPE, Income.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.INCOME_TYPE__ID8:
				return getId8();
			case TaxationWithRootPackage.INCOME_TYPE__INCOME:
				return getIncome();
		}
