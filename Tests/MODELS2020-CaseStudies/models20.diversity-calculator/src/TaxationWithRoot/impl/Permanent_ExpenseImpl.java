...
public class Permanent_ExpenseImpl extends Special_Expense_DSImpl implements Permanent_Expense {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.PERMANENT_EXPENSE;
	}
	...
	public void setCategory(Category_of_Permanent_Expense newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.PERMANENT_EXPENSE__CATEGORY, oldCategory, category));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.PERMANENT_EXPENSE__CATEGORY:
				return getCategory();
		}
