 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.Income_TaxImpl#getTaxPayer <em>Tax Payer</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_TaxImpl#getTax_amount <em>Tax amount</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_TaxImpl#getTax_year <em>Tax year</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Income_TaxImpl#getId6 <em>Id6</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Income_TaxImpl extends MinimalEObjectImpl.Container implements Income_Tax {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.INCOME_TAX;
	}
		...
		if (taxPayer != null && taxPayer.eIsProxy()) {
			...
			if (taxPayer != oldTaxPayer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaxationWithRootPackage.INCOME_TAX__TAX_PAYER, oldTaxPayer, taxPayer));
			}
		}
		return taxPayer;
	}
	...
	public void setTaxPayer(Tax_Payer newTaxPayer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX__TAX_PAYER, oldTaxPayer, taxPayer));
	}
	...
	public void setTax_amount(double newTax_amount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX__TAX_AMOUNT, oldTax_amount, tax_amount));
	}
	...
	public void setTax_year(int newTax_year) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX__TAX_YEAR, oldTax_year, tax_year));
	}
	...
	public void setId6(String newId6) {
		...
		id6 = newId6;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.INCOME_TAX__ID6, oldId6, id6));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.INCOME_TAX__TAX_PAYER:
				if (resolve) return getTaxPayer();
				return basicGetTaxPayer();
			case TaxationWithRootPackage.INCOME_TAX__TAX_AMOUNT:
				return getTax_amount();
			case TaxationWithRootPackage.INCOME_TAX__TAX_YEAR:
				return getTax_year();
			case TaxationWithRootPackage.INCOME_TAX__ID6:
				return getId6();
		}
