 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getCard_identifier <em>Card identifier</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getTax_office <em>Tax office</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getPercentage_of_witholding <em>Percentage of witholding</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getTax_payers_name_surname <em>Tax payers name surname</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getTax_payers_partner_name_surname <em>Tax payers partner name surname</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getTax_payers_address <em>Tax payers address</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getJobs_Employer_SSNo <em>Jobs Employer SS No</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getJobs_employers_name <em>Jobs employers name</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getJobs_activity_type <em>Jobs activity type</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getJobs_place_of_work <em>Jobs place of work</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_FD_daily <em>Deduction FD daily</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_FD_monthly <em>Deduction FD monthly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_AC_daily <em>Deduction AC daily</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_AC_monthly <em>Deduction AC monthly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_AC_yearly <em>Deduction AC yearly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_CE_daily <em>Deduction CE daily</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_CE_monthly <em>Deduction CE monthly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_CE_yearly <em>Deduction CE yearly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_DS_daily <em>Deduction DS daily</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_DS_monthly <em>Deduction DS monthly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_FO_daily <em>Deduction FO daily</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_FO_monthly <em>Deduction FO monthly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_FO_yearly <em>Deduction FO yearly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getCredit_CIS_daily <em>Credit CIS daily</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getCredit_CIS_monthly <em>Credit CIS monthly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getCredit_CIM_daily <em>Credit CIM daily</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#isValidity <em>Validity</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getIncome_Tax_Credit <em>Income Tax Credit</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getPrevious <em>Previous</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getCurrent_tax_card <em>Current tax card</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getCredit_CIM_yearly <em>Credit CIM yearly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_DS_Alimony_yearly <em>Deduction DS Alimony yearly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getDeduction_DS_Debt_yearly <em>Deduction DS Debt yearly</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_CardImpl#getIncome <em>Income</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tax_CardImpl extends MinimalEObjectImpl.Container implements Tax_Card {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.TAX_CARD;
	}
	...
	public void setCard_identifier(String newCard_identifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__CARD_IDENTIFIER, oldCard_identifier, card_identifier));
	}
	...
	public void setTax_office(Tax_Office newTax_office) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__TAX_OFFICE, oldTax_office, tax_office));
	}
	...
	public void setPercentage_of_witholding(double newPercentage_of_witholding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__PERCENTAGE_OF_WITHOLDING, oldPercentage_of_witholding, percentage_of_witholding));
	}
	...
	public EList<String> getTax_payers_name_surname() {
		if (tax_payers_name_surname == null) {
			tax_payers_name_surname = new EDataTypeUniqueEList<String>(String.class, this, TaxationWithRootPackage.TAX_CARD__TAX_PAYERS_NAME_SURNAME);
		}
	...
	public EList<String> getTax_payers_partner_name_surname() {
		if (tax_payers_partner_name_surname == null) {
			tax_payers_partner_name_surname = new EDataTypeUniqueEList<String>(String.class, this, TaxationWithRootPackage.TAX_CARD__TAX_PAYERS_PARTNER_NAME_SURNAME);
		}
	...
	public Address getTax_payers_address() {
		if (tax_payers_address != null && tax_payers_address.eIsProxy()) {
			...
			if (tax_payers_address != oldTax_payers_address) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaxationWithRootPackage.TAX_CARD__TAX_PAYERS_ADDRESS, oldTax_payers_address, tax_payers_address));
			}
		}
	...
	public void setTax_payers_address(Address newTax_payers_address) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__TAX_PAYERS_ADDRESS, oldTax_payers_address, tax_payers_address));
	}
	...
	public void setJobs_Employer_SSNo(String newJobs_Employer_SSNo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__JOBS_EMPLOYER_SS_NO, oldJobs_Employer_SSNo, jobs_Employer_SSNo));
	}
	...
	public void setJobs_employers_name(String newJobs_employers_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__JOBS_EMPLOYERS_NAME, oldJobs_employers_name, jobs_employers_name));
	}
	...
	public void setJobs_activity_type(Job_Activity newJobs_activity_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__JOBS_ACTIVITY_TYPE, oldJobs_activity_type, jobs_activity_type));
	}
	...
	public void setJobs_place_of_work(Town newJobs_place_of_work) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__JOBS_PLACE_OF_WORK, oldJobs_place_of_work, jobs_place_of_work));
	}
	...
	public void setDeduction_FD_daily(double newDeduction_FD_daily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_FD_DAILY, oldDeduction_FD_daily, deduction_FD_daily));
	}
	...
	public void setDeduction_FD_monthly(double newDeduction_FD_monthly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_FD_MONTHLY, oldDeduction_FD_monthly, deduction_FD_monthly));
	}
	...
	public void setDeduction_AC_daily(double newDeduction_AC_daily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_AC_DAILY, oldDeduction_AC_daily, deduction_AC_daily));
	}
	...
	public void setDeduction_AC_monthly(double newDeduction_AC_monthly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_AC_MONTHLY, oldDeduction_AC_monthly, deduction_AC_monthly));
	}
	...
	public void setDeduction_AC_yearly(double newDeduction_AC_yearly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_AC_YEARLY, oldDeduction_AC_yearly, deduction_AC_yearly));
	}
	...
	public void setDeduction_CE_daily(double newDeduction_CE_daily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_CE_DAILY, oldDeduction_CE_daily, deduction_CE_daily));
	}
	...
	public void setDeduction_CE_monthly(double newDeduction_CE_monthly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_CE_MONTHLY, oldDeduction_CE_monthly, deduction_CE_monthly));
	}
	...
	public void setDeduction_CE_yearly(double newDeduction_CE_yearly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_CE_YEARLY, oldDeduction_CE_yearly, deduction_CE_yearly));
	}
	...
	public void setDeduction_DS_daily(double newDeduction_DS_daily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_DS_DAILY, oldDeduction_DS_daily, deduction_DS_daily));
	}
	...
	public void setDeduction_DS_monthly(double newDeduction_DS_monthly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_DS_MONTHLY, oldDeduction_DS_monthly, deduction_DS_monthly));
	}
	...
	public void setDeduction_FO_daily(double newDeduction_FO_daily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_FO_DAILY, oldDeduction_FO_daily, deduction_FO_daily));
	}
	...
	public void setDeduction_FO_monthly(double newDeduction_FO_monthly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_FO_MONTHLY, oldDeduction_FO_monthly, deduction_FO_monthly));
	}
	...
	public void setDeduction_FO_yearly(double newDeduction_FO_yearly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_FO_YEARLY, oldDeduction_FO_yearly, deduction_FO_yearly));
	}
	...
	public void setCredit_CIS_daily(double newCredit_CIS_daily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__CREDIT_CIS_DAILY, oldCredit_CIS_daily, credit_CIS_daily));
	}
	...
	public void setCredit_CIS_monthly(double newCredit_CIS_monthly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__CREDIT_CIS_MONTHLY, oldCredit_CIS_monthly, credit_CIS_monthly));
	}
	...
	public void setCredit_CIM_daily(double newCredit_CIM_daily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__CREDIT_CIM_DAILY, oldCredit_CIM_daily, credit_CIM_daily));
	}
	...
	public void setValidity(boolean newValidity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__VALIDITY, oldValidity, validity));
	}
	...
	public EList<Income_Tax_Credit> getIncome_Tax_Credit() {
		if (income_Tax_Credit == null) {
			income_Tax_Credit = new EObjectWithInverseResolvingEList<Income_Tax_Credit>(Income_Tax_Credit.class, this, TaxationWithRootPackage.TAX_CARD__INCOME_TAX_CREDIT, TaxationWithRootPackage.INCOME_TAX_CREDIT__TAXATION_FRAME);
		}
	...
	public Tax_Card getPrevious() {
		if (previous != null && previous.eIsProxy()) {
			...
			if (previous != oldPrevious) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaxationWithRootPackage.TAX_CARD__PREVIOUS, oldPrevious, previous));
			}
		}
		return previous;
	}
	...
	public NotificationChain basicSetPrevious(Tax_Card newPrevious, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__PREVIOUS, oldPrevious, newPrevious);
	...
	public void setPrevious(Tax_Card newPrevious) {
		if (newPrevious != previous) {
			...
			if (previous != null)
				msgs = ((InternalEObject)previous).eInverseRemove(this, TaxationWithRootPackage.TAX_CARD__CURRENT_TAX_CARD, Tax_Card.class, msgs);
			if (newPrevious != null)
				msgs = ((InternalEObject)newPrevious).eInverseAdd(this, TaxationWithRootPackage.TAX_CARD__CURRENT_TAX_CARD, Tax_Card.class, msgs);
			msgs = basicSetPrevious(newPrevious, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__PREVIOUS, newPrevious, newPrevious));
	}
	...
	public Tax_Card getCurrent_tax_card() {
		if (current_tax_card != null && current_tax_card.eIsProxy()) {
			...
			if (current_tax_card != oldCurrent_tax_card) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaxationWithRootPackage.TAX_CARD__CURRENT_TAX_CARD, oldCurrent_tax_card, current_tax_card));
			}
		}
	...
	public NotificationChain basicSetCurrent_tax_card(Tax_Card newCurrent_tax_card, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__CURRENT_TAX_CARD, oldCurrent_tax_card, newCurrent_tax_card);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCurrent_tax_card(Tax_Card newCurrent_tax_card) {
		if (newCurrent_tax_card != current_tax_card) {
			...
			if (current_tax_card != null)
				msgs = ((InternalEObject)current_tax_card).eInverseRemove(this, TaxationWithRootPackage.TAX_CARD__PREVIOUS, Tax_Card.class, msgs);
			if (newCurrent_tax_card != null)
				msgs = ((InternalEObject)newCurrent_tax_card).eInverseAdd(this, TaxationWithRootPackage.TAX_CARD__PREVIOUS, Tax_Card.class, msgs);
			msgs = basicSetCurrent_tax_card(newCurrent_tax_card, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__CURRENT_TAX_CARD, newCurrent_tax_card, newCurrent_tax_card));
	}
	...
	public void setCredit_CIM_yearly(double newCredit_CIM_yearly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__CREDIT_CIM_YEARLY, oldCredit_CIM_yearly, credit_CIM_yearly));
	}
	...
	public void setDeduction_DS_Alimony_yearly(double newDeduction_DS_Alimony_yearly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_DS_ALIMONY_YEARLY, oldDeduction_DS_Alimony_yearly, deduction_DS_Alimony_yearly));
	}
	...
	public void setDeduction_DS_Debt_yearly(double newDeduction_DS_Debt_yearly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__DEDUCTION_DS_DEBT_YEARLY, oldDeduction_DS_Debt_yearly, deduction_DS_Debt_yearly));
	}
	...
	public Income getIncome() {
		if (eContainerFeatureID() != TaxationWithRootPackage.TAX_CARD__INCOME) return null;
	...
	public NotificationChain basicSetIncome(Income newIncome, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newIncome, TaxationWithRootPackage.TAX_CARD__INCOME, msgs);
		return msgs;
	}
	...
	public void setIncome(Income newIncome) {
		if (newIncome != eInternalContainer() || (eContainerFeatureID() != TaxationWithRootPackage.TAX_CARD__INCOME && newIncome != null)) {
			...
			if (newIncome != null)
				msgs = ((InternalEObject)newIncome).eInverseAdd(this, TaxationWithRootPackage.INCOME__TAX_CARD, Income.class, msgs);
			msgs = basicSetIncome(newIncome, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_CARD__INCOME, newIncome, newIncome));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.TAX_CARD__INCOME_TAX_CREDIT:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncome_Tax_Credit()).basicAdd(otherEnd, msgs);
			case TaxationWithRootPackage.TAX_CARD__PREVIOUS:
				if (previous != null)
					msgs = ((InternalEObject)previous).eInverseRemove(this, TaxationWithRootPackage.TAX_CARD__CURRENT_TAX_CARD, Tax_Card.class, msgs);
				return basicSetPrevious((Tax_Card)otherEnd, msgs);
			case TaxationWithRootPackage.TAX_CARD__CURRENT_TAX_CARD:
				if (current_tax_card != null)
					msgs = ((InternalEObject)current_tax_card).eInverseRemove(this, TaxationWithRootPackage.TAX_CARD__PREVIOUS, Tax_Card.class, msgs);
				return basicSetCurrent_tax_card((Tax_Card)otherEnd, msgs);
			case TaxationWithRootPackage.TAX_CARD__INCOME:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TaxationWithRootPackage.TAX_CARD__INCOME:
				return eInternalContainer().eInverseRemove(this, TaxationWithRootPackage.INCOME__TAX_CARD, Income.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.TAX_CARD__CARD_IDENTIFIER:
				return getCard_identifier();
			case TaxationWithRootPackage.TAX_CARD__TAX_OFFICE:
				return getTax_office();
			case TaxationWithRootPackage.TAX_CARD__PERCENTAGE_OF_WITHOLDING:
				return getPercentage_of_witholding();
			case TaxationWithRootPackage.TAX_CARD__TAX_PAYERS_NAME_SURNAME:
				return getTax_payers_name_surname();
			case TaxationWithRootPackage.TAX_CARD__TAX_PAYERS_PARTNER_NAME_SURNAME:
				return getTax_payers_partner_name_surname();
			case TaxationWithRootPackage.TAX_CARD__TAX_PAYERS_ADDRESS:
				if (resolve) return getTax_payers_address();
				return basicGetTax_payers_address();
			case TaxationWithRootPackage.TAX_CARD__JOBS_EMPLOYER_SS_NO:
				return getJobs_Employer_SSNo();
			case TaxationWithRootPackage.TAX_CARD__JOBS_EMPLOYERS_NAME:
				return getJobs_employers_name();
			case TaxationWithRootPackage.TAX_CARD__JOBS_ACTIVITY_TYPE:
				return getJobs_activity_type();
			case TaxationWithRootPackage.TAX_CARD__JOBS_PLACE_OF_WORK:
				return getJobs_place_of_work();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_FD_DAILY:
				return getDeduction_FD_daily();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_FD_MONTHLY:
				return getDeduction_FD_monthly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_AC_DAILY:
				return getDeduction_AC_daily();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_AC_MONTHLY:
				return getDeduction_AC_monthly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_AC_YEARLY:
				return getDeduction_AC_yearly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_CE_DAILY:
				return getDeduction_CE_daily();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_CE_MONTHLY:
				return getDeduction_CE_monthly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_CE_YEARLY:
				return getDeduction_CE_yearly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_DS_DAILY:
				return getDeduction_DS_daily();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_DS_MONTHLY:
				return getDeduction_DS_monthly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_FO_DAILY:
				return getDeduction_FO_daily();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_FO_MONTHLY:
				return getDeduction_FO_monthly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_FO_YEARLY:
				return getDeduction_FO_yearly();
			case TaxationWithRootPackage.TAX_CARD__CREDIT_CIS_DAILY:
				return getCredit_CIS_daily();
			case TaxationWithRootPackage.TAX_CARD__CREDIT_CIS_MONTHLY:
				return getCredit_CIS_monthly();
			case TaxationWithRootPackage.TAX_CARD__CREDIT_CIM_DAILY:
				return getCredit_CIM_daily();
			case TaxationWithRootPackage.TAX_CARD__VALIDITY:
				return isValidity();
			case TaxationWithRootPackage.TAX_CARD__INCOME_TAX_CREDIT:
			...
			case TaxationWithRootPackage.TAX_CARD__CREDIT_CIM_YEARLY:
				return getCredit_CIM_yearly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_DS_ALIMONY_YEARLY:
				return getDeduction_DS_Alimony_yearly();
			case TaxationWithRootPackage.TAX_CARD__DEDUCTION_DS_DEBT_YEARLY:
