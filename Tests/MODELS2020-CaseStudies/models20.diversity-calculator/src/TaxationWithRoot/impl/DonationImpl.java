...
public class DonationImpl extends Special_Expense_DSImpl implements Donation {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.DONATION;
	}
	...
	public void setBeneficiary1(String newBeneficiary1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.DONATION__BENEFICIARY1, oldBeneficiary1, beneficiary1));
	}
	...
	public void setIs_donation_reported(boolean newIs_donation_reported) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.DONATION__IS_DONATION_REPORTED, oldIs_donation_reported, is_donation_reported));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.DONATION__BENEFICIARY1:
				return getBeneficiary1();
			case TaxationWithRootPackage.DONATION__IS_DONATION_REPORTED:
