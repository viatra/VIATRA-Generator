 ...
 * </p>
 * <ul>
 *   <li>{@link TaxationWithRoot.impl.Tax_PayerImpl#getDependents <em>Dependents</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_PayerImpl#getFrom_agent <em>From agent</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_PayerImpl#getIncomes <em>Incomes</em>}</li>
 *   <li>{@link TaxationWithRoot.impl.Tax_PayerImpl#getFrom_law <em>From law</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class Tax_PayerImpl extends Physical_PersonImpl implements Tax_Payer {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.TAX_PAYER;
	}
	...
	public EList<Dependent> getDependents() {
		if (dependents == null) {
			dependents = new EObjectContainmentWithInverseEList<Dependent>(Dependent.class, this, TaxationWithRootPackage.TAX_PAYER__DEPENDENTS, TaxationWithRootPackage.DEPENDENT__RESPONSIBLE_PERSON);
		}
		return dependents;
	}
	...
	public NotificationChain basicSetFrom_agent(FromAgent newFrom_agent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_PAYER__FROM_AGENT, oldFrom_agent, newFrom_agent);
	...
	public void setFrom_agent(FromAgent newFrom_agent) {
		if (newFrom_agent != from_agent) {
			...
			if (from_agent != null)
				msgs = ((InternalEObject)from_agent).eInverseRemove(this, TaxationWithRootPackage.FROM_AGENT__TAX_PAYER, FromAgent.class, msgs);
			if (newFrom_agent != null)
				msgs = ((InternalEObject)newFrom_agent).eInverseAdd(this, TaxationWithRootPackage.FROM_AGENT__TAX_PAYER, FromAgent.class, msgs);
			msgs = basicSetFrom_agent(newFrom_agent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_PAYER__FROM_AGENT, newFrom_agent, newFrom_agent));
	}
	...
	public EList<Income> getIncomes() {
		if (incomes == null) {
			incomes = new EObjectContainmentWithInverseEList<Income>(Income.class, this, TaxationWithRootPackage.TAX_PAYER__INCOMES, TaxationWithRootPackage.INCOME__TAX_PAYER);
		}
		return incomes;
	}
	...
	public NotificationChain basicSetFrom_law(FromLaw newFrom_law, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_PAYER__FROM_LAW, oldFrom_law, newFrom_law);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFrom_law(FromLaw newFrom_law) {
		if (newFrom_law != from_law) {
			NotificationChain msgs = null;
			if (from_law != null)
				msgs = ((InternalEObject)from_law).eInverseRemove(this, TaxationWithRootPackage.FROM_LAW__TAX_PAYER, FromLaw.class, msgs);
			if (newFrom_law != null)
				msgs = ((InternalEObject)newFrom_law).eInverseAdd(this, TaxationWithRootPackage.FROM_LAW__TAX_PAYER, FromLaw.class, msgs);
			msgs = basicSetFrom_law(newFrom_law, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.TAX_PAYER__FROM_LAW, newFrom_law, newFrom_law));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaxationWithRootPackage.TAX_PAYER__DEPENDENTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getDependents()).basicAdd(otherEnd, msgs);
			case TaxationWithRootPackage.TAX_PAYER__FROM_AGENT:
				if (from_agent != null)
					msgs = ((InternalEObject)from_agent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TaxationWithRootPackage.TAX_PAYER__FROM_AGENT, null, msgs);
				return basicSetFrom_agent((FromAgent)otherEnd, msgs);
			case TaxationWithRootPackage.TAX_PAYER__INCOMES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncomes()).basicAdd(otherEnd, msgs);
			case TaxationWithRootPackage.TAX_PAYER__FROM_LAW:
				if (from_law != null)
					msgs = ((InternalEObject)from_law).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TaxationWithRootPackage.TAX_PAYER__FROM_LAW, null, msgs);
