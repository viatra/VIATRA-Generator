...
public class Extraordinary_Expense_CEImpl extends ExpenseImpl implements Extraordinary_Expense_CE {
	...
	protected EClass eStaticClass() {
		return TaxationWithRootPackage.Literals.EXTRAORDINARY_EXPENSE_CE;
	}
	...
	public void setThresholded_deduction_percentage(double newThresholded_deduction_percentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.EXTRAORDINARY_EXPENSE_CE__THRESHOLDED_DEDUCTION_PERCENTAGE, oldThresholded_deduction_percentage, thresholded_deduction_percentage));
	}
	...
	public void setCe_type(CE_Type newCe_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationWithRootPackage.EXTRAORDINARY_EXPENSE_CE__CE_TYPE, oldCe_type, ce_type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaxationWithRootPackage.EXTRAORDINARY_EXPENSE_CE__THRESHOLDED_DEDUCTION_PERCENTAGE:
				return getThresholded_deduction_percentage();
			case TaxationWithRootPackage.EXTRAORDINARY_EXPENSE_CE__CE_TYPE:
				return getCe_type();
		}
