 ...
 * </ul>
 *
 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record()
 * @model abstract="true"
 * @generated
 */
public interface Legal_Union_Record extends EObject {
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_Start_year()
	 * @model required="true"
	 * @generated
	 */
	int getStart_year();
	 ...
	 * @see #setEnd_year(int)
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_End_year()
	 * @model required="true"
	 * @generated
	 */
	int getEnd_year();
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_Separation_cause()
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_Individual_A()
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_Individual_B()
	 * @model containment="true" required="true" ordered="false"
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_Properties()
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_Mutual_agreement()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see #setId9(String)
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_Id9()
	 ...
	 * @see TaxationWithRoot.TaxationWithRootPackage#getLegal_Union_Record_Household()
