 ...
 * </ul>
 *
 * @see TaxationWithRoot.TaxationPackage#getTax_Payer()
 * @model abstract="true"
...
public interface Tax_Payer extends Physical_Person, Tax_Case, Root {
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getTax_Payer_Dependents()
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getTax_Payer_From_agent()
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getTax_Payer_Incomes()
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getTax_Payer_From_law()
