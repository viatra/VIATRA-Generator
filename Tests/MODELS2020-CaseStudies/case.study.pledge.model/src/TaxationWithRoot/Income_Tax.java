...
public interface Income_Tax extends EObject {
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_TaxPayer()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Tax_amount()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * @see #setTax_year(int)
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Tax_year()
	 * @model required="true"
	 * @generated
	 */
	int getTax_year();
	 ...
	 * @see #setId6(String)
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Id6()
