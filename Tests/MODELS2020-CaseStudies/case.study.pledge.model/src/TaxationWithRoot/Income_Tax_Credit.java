 ...
 * </ul>
 *
 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Credit()
 * @model
 * @generated
 */
public interface Income_Tax_Credit extends Root {
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Credit_TaxPayer()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setTax_year(int)
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Credit_Tax_year()
	 * @model required="true"
	 * @generated
	 */
	int getTax_year();
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Credit_Yearly()
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Credit_Monthly()
	 ...
	 * @see #setDaily(double)
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Credit_Daily()
	 ...
	 * @see #setId7(String)
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Credit_Id7()
	 ...
	 * @see TaxationWithRoot.TaxationPackage#getIncome_Tax_Credit_Taxation_Frame()
