 ...
 * </p>
 * <ul>
 *   <li>{@link Taxation.FromAgent#getTaxPayer <em>Tax Payer</em>}</li>
 *   <li>{@link Taxation.FromAgent#isIs_dependent_eligible_for_CE_Not_In_Houshold_Children_Care <em>Is dependent eligible for CE Not In Houshold Children Care</em>}</li>
 *   <li>{@link Taxation.FromAgent#getExpense <em>Expense</em>}</li>
 *   <li>{@link Taxation.FromAgent#isIs_eligible_debt <em>Is eligible debt</em>}</li>
 *   <li>{@link Taxation.FromAgent#getDependent <em>Dependent</em>}</li>
 * </ul>
 *
 * @see Taxation.TaxationPackage#getFromAgent()
 * @model
 * @generated
 */
public interface FromAgent extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link Taxation.Tax_Payer#getFrom_agent <em>From agent</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Tax Payer</em>' container reference.
	 * @see #setTaxPayer(Tax_Payer)
	 * @see Taxation.TaxationPackage#getFromAgent_TaxPayer()
	...
	/**
	 * Sets the value of the '{@link Taxation.FromAgent#getTaxPayer <em>Tax Payer</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Taxation.TaxationPackage#getFromAgent_Is_dependent_eligible_for_CE_Not_In_Houshold_Children_Care()
	...
	/**
	 * Sets the value of the '{@link Taxation.FromAgent#isIs_dependent_eligible_for_CE_Not_In_Houshold_Children_Care <em>Is dependent eligible for CE Not In Houshold Children Care</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link Taxation.Expense#getFrom_agent <em>From agent</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Expense</em>' reference.
	 * @see #setExpense(Expense)
	 * @see Taxation.TaxationPackage#getFromAgent_Expense()
	...
	/**
	 * Sets the value of the '{@link Taxation.FromAgent#getExpense <em>Expense</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Taxation.TaxationPackage#getFromAgent_Is_eligible_debt()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Taxation.FromAgent#isIs_eligible_debt <em>Is eligible debt</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link Taxation.Dependent#getFrom_agent <em>From agent</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Dependent</em>' reference.
	 * @see #setDependent(Dependent)
	 * @see Taxation.TaxationPackage#getFromAgent_Dependent()
	...
	/**
	 * Sets the value of the '{@link Taxation.FromAgent#getDependent <em>Dependent</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
