 ...
 * </p>
 * <ul>
 *   <li>{@link Taxation.Income_Tax#getTaxPayer <em>Tax Payer</em>}</li>
 *   <li>{@link Taxation.Income_Tax#getTax_amount <em>Tax amount</em>}</li>
 *   <li>{@link Taxation.Income_Tax#getTax_year <em>Tax year</em>}</li>
 *   <li>{@link Taxation.Income_Tax#getId6 <em>Id6</em>}</li>
 * </ul>
 *
 * @see Taxation.TaxationPackage#getIncome_Tax()
 * @model
 * @generated
 */
public interface Income_Tax extends EObject {
	 ...
	 * @see Taxation.TaxationPackage#getIncome_Tax_TaxPayer()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Taxation.Income_Tax#getTaxPayer <em>Tax Payer</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Taxation.TaxationPackage#getIncome_Tax_Tax_amount()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Taxation.Income_Tax#getTax_amount <em>Tax amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTax_year(int)
	 * @see Taxation.TaxationPackage#getIncome_Tax_Tax_year()
	 * @model required="true"
	 * @generated
	 */
	int getTax_year();
	...
	/**
	 * Sets the value of the '{@link Taxation.Income_Tax#getTax_year <em>Tax year</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setId6(String)
	 * @see Taxation.TaxationPackage#getIncome_Tax_Id6()
	...
	/**
	 * Sets the value of the '{@link Taxation.Income_Tax#getId6 <em>Id6</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
