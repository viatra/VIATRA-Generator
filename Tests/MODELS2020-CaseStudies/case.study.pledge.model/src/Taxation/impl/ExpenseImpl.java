 ...
 * </p>
 * <ul>
 *   <li>{@link Taxation.impl.ExpenseImpl#getDeclared_amount <em>Declared amount</em>}</li>
 *   <li>{@link Taxation.impl.ExpenseImpl#getExpense_purpose <em>Expense purpose</em>}</li>
 *   <li>{@link Taxation.impl.ExpenseImpl#getDependent <em>Dependent</em>}</li>
 *   <li>{@link Taxation.impl.ExpenseImpl#getFrom_agent <em>From agent</em>}</li>
 *   <li>{@link Taxation.impl.ExpenseImpl#getIncome <em>Income</em>}</li>
 *   <li>{@link Taxation.impl.ExpenseImpl#getId4 <em>Id4</em>}</li>
 *   <li>{@link Taxation.impl.ExpenseImpl#getBeneficiary <em>Beneficiary</em>}</li>
 * </ul>
 *
 * @generated
 */
