 ...
 * </p>
 * <ul>
 *   <li>{@link Taxation.impl.Income_Tax_CreditImpl#getGrantedBy <em>Granted By</em>}</li>
 *   <li>{@link Taxation.impl.Income_Tax_CreditImpl#getTaxPayer <em>Tax Payer</em>}</li>
 *   <li>{@link Taxation.impl.Income_Tax_CreditImpl#getTax_year <em>Tax year</em>}</li>
 *   <li>{@link Taxation.impl.Income_Tax_CreditImpl#getYearly <em>Yearly</em>}</li>
 *   <li>{@link Taxation.impl.Income_Tax_CreditImpl#getMonthly <em>Monthly</em>}</li>
 *   <li>{@link Taxation.impl.Income_Tax_CreditImpl#getDaily <em>Daily</em>}</li>
 *   <li>{@link Taxation.impl.Income_Tax_CreditImpl#getId7 <em>Id7</em>}</li>
 *   <li>{@link Taxation.impl.Income_Tax_CreditImpl#getTaxation_Frame <em>Taxation Frame</em>}</li>
 * </ul>
 *
 * @generated
 */
