 ...
 * </p>
 * <ul>
 *   <li>{@link Taxation.impl.DependentImpl#getDependent_type <em>Dependent type</em>}</li>
 *   <li>{@link Taxation.impl.DependentImpl#getResponsible_person <em>Responsible person</em>}</li>
 *   <li>{@link Taxation.impl.DependentImpl#isContinued_studies <em>Continued studies</em>}</li>
 *   <li>{@link Taxation.impl.DependentImpl#getAllowances <em>Allowances</em>}</li>
 *   <li>{@link Taxation.impl.DependentImpl#getHousehold <em>Household</em>}</li>
 *   <li>{@link Taxation.impl.DependentImpl#getFrom_agent <em>From agent</em>}</li>
 *   <li>{@link Taxation.impl.DependentImpl#getExpense <em>Expense</em>}</li>
 * </ul>
 *
 * @generated
 */
