 ...
 * </p>
 * <ul>
 *   <li>{@link Taxation.impl.Pensions_and_Annuities_IncomeImpl#isOccasional_payement <em>Occasional payement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pensions_and_Annuities_IncomeImpl extends Income_TypeImpl implements Pensions_and_Annuities_Income {
	...
	protected EClass eStaticClass() {
		return TaxationPackage.Literals.PENSIONS_AND_ANNUITIES_INCOME;
	}
	...
	public void setOccasional_payement(boolean newOccasional_payement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxationPackage.PENSIONS_AND_ANNUITIES_INCOME__OCCASIONAL_PAYEMENT, oldOccasional_payement, occasional_payement));
	}
