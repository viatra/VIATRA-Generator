...
java -Xms12G -jar gencache.jar -d FamilyTree -lb 150 -ub 170
java -Xms12G -jar gencache.jar -d TaxationNoRoot -lb 150 -ub 200
java -Xms12G -jar gencache.jar -d TaxationWithRoot -lb 150 -ub 200 -hh 3

java -Xms12G -jar gencache.jar -d Satellite -lb 200 -ub 220
java -Xms12G -jar gencache.jar -d FamilyTree -lb 200 -ub 220
java -Xms12G -jar gencache.jar -d TaxationNoRoot -lb 200 -ub 250
java -Xms12G -jar gencache.jar -d TaxationWithRoot -lb 200 -ub 250 -hh 4