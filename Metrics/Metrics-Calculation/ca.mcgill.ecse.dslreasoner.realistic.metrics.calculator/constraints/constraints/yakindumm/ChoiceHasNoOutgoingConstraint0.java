...
public class ChoiceHasNoOutgoingConstraint0 implements IConstraintSpecification {

    private ChoiceHasNoOutgoing querySpecification;

    public ChoiceHasNoOutgoingConstraint0() {
        querySpecification = ChoiceHasNoOutgoing.instance();
    }
