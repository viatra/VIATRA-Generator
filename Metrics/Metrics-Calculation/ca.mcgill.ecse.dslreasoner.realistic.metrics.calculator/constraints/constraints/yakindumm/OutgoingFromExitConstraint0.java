...
public class OutgoingFromExitConstraint0 implements IConstraintSpecification {

    private OutgoingFromExit querySpecification;

    public OutgoingFromExitConstraint0() {
        querySpecification = OutgoingFromExit.instance();
    }
