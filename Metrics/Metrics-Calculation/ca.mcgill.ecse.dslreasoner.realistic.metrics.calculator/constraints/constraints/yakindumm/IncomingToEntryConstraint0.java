...
public class IncomingToEntryConstraint0 implements IConstraintSpecification {

    private IncomingToEntry querySpecification;

    public IncomingToEntryConstraint0() {
        querySpecification = IncomingToEntry.instance();
    }
