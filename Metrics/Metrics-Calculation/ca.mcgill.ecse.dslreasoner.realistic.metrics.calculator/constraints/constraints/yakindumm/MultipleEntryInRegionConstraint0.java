...
public class MultipleEntryInRegionConstraint0 implements IConstraintSpecification {

    private MultipleEntryInRegion querySpecification;

    public MultipleEntryInRegionConstraint0() {
        querySpecification = MultipleEntryInRegion.instance();
    }
