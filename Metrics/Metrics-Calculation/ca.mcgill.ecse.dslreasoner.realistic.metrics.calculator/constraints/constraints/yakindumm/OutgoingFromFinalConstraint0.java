...
public class OutgoingFromFinalConstraint0 implements IConstraintSpecification {

    private OutgoingFromFinal querySpecification;

    public OutgoingFromFinalConstraint0() {
        querySpecification = OutgoingFromFinal.instance();
    }
