...
public class NoStateInRegionConstraint0 implements IConstraintSpecification {

    private NoStateInRegion querySpecification;

    public NoStateInRegionConstraint0() {
        querySpecification = NoStateInRegion.instance();
    }
    ...
    public Map<String,Object> getKeyObjects(IPatternMatch signature) {
        ...
        map.put("region",signature.get("region"));
        return map;
    }
