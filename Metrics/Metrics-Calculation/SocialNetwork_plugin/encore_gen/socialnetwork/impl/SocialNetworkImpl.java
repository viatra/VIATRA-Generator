 ...
 * </p>
 * <ul>
 *   <li>{@link socialnetwork.impl.SocialNetworkImpl#getName <em>Name</em>}</li>
 *   <li>{@link socialnetwork.impl.SocialNetworkImpl#getPersons <em>Persons</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SocialNetworkImpl extends MinimalEObjectImpl.Container implements SocialNetwork {
	 ...
	 * @ordered
	 */
	protected static final String NAME_EDEFAULT = "SocialNetwork";
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SocialnetworkPackage.SOCIAL_NETWORK__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SocialnetworkPackage.SOCIAL_NETWORK__NAME:
			return getName();
		case SocialnetworkPackage.SOCIAL_NETWORK__PERSONS:
			return getPersons();
		}
