...
public class CalcNDA {
  ...
  public static double getNDAfromNHLattice(final PartialInterpretation pm) {
    return CalcNDA.getNDAfromNHLattice(pm, Integer.valueOf(1));
  }
  
  public static double getNDAfromNHLattice(final PartialInterpretation pm, final Integer depth) {
    ...
    return CalcNDA.getNDAfromNHLattice(nhDeepRep, nhRep, depth);
  }
  
  public static double getNDAfromNHLattice(final HashMap nhDeepRep, final HashMap nhRep, final Integer depth) {
