...
[
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[State class, CompositeElement class, Vertex class, RegularState class] (21)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[Choice class, Pseudostate class, Vertex class] (14)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
