...
[
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[State class, CompositeElement class, Vertex class, RegularState class] (25)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[Pseudostate class, Entry class, Vertex class] (7)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	...
	edge
		[
			...
			LabelGraphics
			[
				text	"[1, 1, 2, 2, 1, 3, 2, 2, 1, 4, 6, 0, 1]"
				fontSize	12
				fontName	"Dialog"
				configuration	"AutoFlippingLabel"
				model	"six_pos"
