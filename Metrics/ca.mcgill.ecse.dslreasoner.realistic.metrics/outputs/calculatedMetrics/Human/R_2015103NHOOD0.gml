...
[
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[State class, CompositeElement class, Vertex class, RegularState class] (22)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	...
	edge
		[
			...
			LabelGraphics
			[
				text	"[4, 3, 4, 3, 3, 1, 4, 4, 3, 1, 2, 2, 2]"
				fontSize	12
				fontName	"Dialog"
				configuration	"AutoFlippingLabel"
				model	"six_pos"
