...
[
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[State class, CompositeElement class, Vertex class, RegularState class] (12)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[Choice class, Pseudostate class, Vertex class] (1)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	node
		[
			...
			LabelGraphics
			[
				text	"[Pseudostate class, Entry class, Vertex class] (2)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
