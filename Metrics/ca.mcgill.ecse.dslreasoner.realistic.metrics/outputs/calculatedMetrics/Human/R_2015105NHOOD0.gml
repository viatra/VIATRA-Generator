...
[
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[State class, CompositeElement class, Vertex class, RegularState class] (15)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[Choice class, Pseudostate class, Vertex class] (8)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	node
		[
			...
			LabelGraphics
			[
				text	"[Pseudostate class, Entry class, Vertex class] (3)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
