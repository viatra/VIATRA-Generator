...
[
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[State class, CompositeElement class, Vertex class, RegularState class] (11)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
	...
	node
		[
			...
			LabelGraphics
			[
				text	"[Choice class, Pseudostate class, Vertex class] (11)" 
				fontSize	14
				fontName	"Dialog"
			]
		]
