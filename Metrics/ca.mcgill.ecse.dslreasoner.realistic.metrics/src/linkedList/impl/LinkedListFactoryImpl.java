...
public class LinkedListFactoryImpl extends EFactoryImpl implements LinkedListFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case LinkedListPackage.LIST: return createList();
			case LinkedListPackage.ELEMENT: return createElement();
			case LinkedListPackage.OBJECT: return createObject();
			default:
	 ...
	 * @generated
	 */
	public linkedList.Object createObject() {
